...
all: criar_pasta_obj src/obj/Camera.o src/obj/ElementBuffer.o src/obj/Main.o \
	 src/obj/SceneObject.o src/obj/Renderer.o src/obj/Scene.o src/obj/Shader.o \
	 src/obj/VertexArray.o src/obj/VertexBuffer.o Main
...
src/obj/SceneObject.o: src/SceneObject.cpp src/SceneObject.h src/VertexArray.h \
...
Main: src/obj/Camera.o src/obj/ElementBuffer.o src/obj/Main.o src/obj/SceneObject.o \
	  src/obj/Scene.o src/obj/Shader.o src/obj/Renderer.o src/obj/VertexArray.o \
	  src/obj/VertexBuffer.o
	@echo compilando $@
